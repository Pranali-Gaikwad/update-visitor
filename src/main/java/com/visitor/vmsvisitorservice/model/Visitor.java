...
public class Visitor {
	...
	/*
	 * public Visitor(long id, @NotEmpty(message = "first name cannot be empty")
	 * String name, @Email String email, String mobileNo, @NotEmpty(message =
	 * "address cannot be empty") String address,
	 * 
	 * @NotEmpty(message = "idProof cannot be empty") String idProof,
	 * 
	 * @NotEmpty(message = "contactPersonName cannot be empty") String
	 * contactPersonName,
	 * 
	 * @NotEmpty(message = "contactPersonEmail cannot be empty") String
	 * contactPersonEmail,
	 * 
	 * @NotEmpty(message = "reasonForVisit cannot be empty") String reasonForVisit,
	 * int status, String contactPersonMobileNo) { super(); this.id = id; this.name
	 * = name; this.email = email; this.mobileNo = mobileNo; this.address = address;
	 * this.idProof = idProof; this.contactPersonName = contactPersonName;
	 * this.contactPersonEmail = contactPersonEmail; this.reasonForVisit =
	 * reasonForVisit; this.status = status; this.contactPersonMobileNo =
